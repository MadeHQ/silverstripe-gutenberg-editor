    ...
    <div class="inline-gallery__list  js-inline-gallery__list">
        <% loop $Images %>
            <div class="inline-gallery__item">
                <figure class="gallery-item o-figure" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" data-width="{$Width}" data-height="{$Height}" data-large-src="{$Image.Size($Width, $Height).Crop('fit')}" data-caption="{$Caption}" data-credit="{$Credit}">
